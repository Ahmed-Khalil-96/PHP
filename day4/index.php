...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($errors)) {
            ...
            $sql = "INSERT INTO form (Name, Email, `Group`, Class_details, Gender, courses, checked) VALUES ('$name', '$email', $group, '$class_details', '$gender', '$courses', '$agree')";
        ...
        // } else {
        //     echo "<h3 class='required'>Please fill in all fields</h3>";
        // }
    }
    ?>
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        ...
        <label for="agree">Receive E-mails from us<span class="required"><?php echo(isset($errors['agree']) && empty($agree))? "*(you must agree to terms)":"";?></span></label>
